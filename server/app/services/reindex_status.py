"""
In-memory status for the AI content-indexing (re-embed) job.
Mirrors ca_ingestion_status.py so the Admin UI can poll it.
Poll via GET /api/v1/ai/admin/reindex-status (Admin only).
"""
