  ...
  return (
    <header className="sticky top-0 z-[100] flex items-center justify-between py-4 px-8 bg-bg-panel border-b border-border-default shadow-[0_4px_24px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="bg-primary hover:bg-primary-hover text-text-primary border-none py-2 px-4 rounded-md text-[13px] font-medium flex items-center gap-2 transition-colors cursor-pointer">
          <PenLine size={16} />
